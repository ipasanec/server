...
const actions = {
	...
	getUsers(context, { offset, limit, search, group }) {
		...
		if (group !== '') {
			return api.get(generateOcsUrl('cloud/groups/{g}/users/details?offset={o}&limit={l}&search={s}', { g: encodeURIComponent(group), o: offset, l: limit, s: search }), {
	...
	getUsersFromGroup(context, { groupid, offset, limit }) {
		return api.get(generateOcsUrl('cloud/users/{g}/details?offset={o}&limit={l}', { g: encodeURIComponent(groupid), o: offset, l: limit }))
	...
	removeGroup(context, gid) {
		return api.requireAdmin().then((response) => {
			return api.delete(generateOcsUrl('cloud/groups/{g}', { g: encodeURIComponent(gid) }))
